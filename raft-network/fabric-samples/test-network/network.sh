...
CC_NAME="fixm-to-acris-contract"
# chaincode path defaults to "NA"
CC_SRC_PATH="/home/sethuraman/Documents/Workspace/IBS/DataMapping/Benchmark/Fabirc_Networks/raft-network/fabric-samples/flight-chain-smart-contract-Fabric-2.x-Upgrade"
